...
class AdminsController(BaseController):
    ...
    def create_organization_admins(self,
            ...
            options (dict, optional): Key-value pairs for any of the
                ...
                of parameters that can be used are::
                    ...
                    organization_id -- string -- TODO: type description here.
                        Example: 
                    create_organization_admins --
                        CreateOrganizationAdminsModel -- TODO: type
        ...
        self.validate_parameters(organization_id=options.get("organization_id"),
                                 create_organization_admins=options.get("create_organization_admins"))
        ...
        # Prepare and execute request
        _request = self.http_client.post(_query_url, headers=_headers, parameters=APIHelper.json_serialize(options.get('create_organization_admins')))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
